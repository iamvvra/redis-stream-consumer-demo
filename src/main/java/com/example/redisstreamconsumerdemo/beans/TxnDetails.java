...
public class TxnDetails implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = 7684903267503859573L;
    ...
    private Integer txnAgentStatus;
    @JsonProperty("txnAgentStatus2")
    private Integer txnAgentStatus2;
    ...
    private Integer customerStatus2;
    ...
    private Integer beneficiaryAccountConvertible;
    ...
    private Integer instrumentClass;
    ...
    @JsonProperty("isF2Lc")
    private Boolean isF2Lc;

    @JsonProperty("ibrSettlementRates2AgentList")
    private List<IBRSettlementRates2Agent> ibrSettlementRates2AgentList;

    @JsonProperty("hybridPaymentTxnDetailsList")
    private List<HybridPaymentTxnDetails> hybridPaymentTxnDetailsList;
